...
public:
    ...
    void on_create_column_family(const sstring& ks_name, const sstring& cf_name) override {
        logger.info("Audit: table {}.{} created, adding to known tables", ks_name, cf_name);
        _rules.add_known_table(ks_name, cf_name);
    }

    void on_drop_column_family(const sstring& ks_name, const sstring& cf_name) override {
        logger.info("Audit: table {}.{} dropped, removing from known tables", ks_name, cf_name);
        _rules.remove_known_table(ks_name, cf_name);
    }

    void on_create_view(const sstring& ks_name, const sstring& view_name) override {
        logger.info("Audit: table {}.{} created, adding to known tables", ks_name, view_name);
        _rules.add_known_table(ks_name, view_name);
    }

    void on_drop_view(const sstring& ks_name, const sstring& view_name) override {
        logger.info("Audit: table {}.{} dropped, removing from known tables", ks_name, view_name);
