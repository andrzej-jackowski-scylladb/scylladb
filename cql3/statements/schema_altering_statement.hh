...
protected:
    explicit schema_altering_statement(dialect d, timeout_config_selector timeout_selector = &timeout_config::other_timeout);

    schema_altering_statement(cf_name name, dialect d, timeout_config_selector timeout_selector = &timeout_config::other_timeout);
