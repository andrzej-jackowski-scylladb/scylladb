...
std::unique_ptr<prepared_statement> drop_aggregate_statement::do_prepare(data_dictionary::database db, prepare_context& ctx, cql_stats& stats, const cql_config& cfg) {
