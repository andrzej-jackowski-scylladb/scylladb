...
drop_keyspace_statement::drop_keyspace_statement(const sstring& keyspace, bool if_exists, dialect d)
    : schema_altering_statement(d, &timeout_config::truncate_timeout)
    , _keyspace{keyspace}
