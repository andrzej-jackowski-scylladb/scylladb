...
drop_index_statement::drop_index_statement(::shared_ptr<index_name> index_name, bool if_exists, dialect d)
    : schema_altering_statement{index_name->get_cf_name(), d, &timeout_config::truncate_timeout}
