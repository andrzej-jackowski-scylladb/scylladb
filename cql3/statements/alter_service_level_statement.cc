...
alter_service_level_statement::alter_service_level_statement(sstring service_level, shared_ptr<sl_prop_defs> attrs, dialect d)
        : service_level_statement(d), _service_level(service_level) {
    attrs->validate();
