...
insert_statement::insert_statement(cf_name name,
                                   ...
                                   bool if_not_exists,
                                   dialect d)
    : raw::modification_statement{std::move(name), std::move(attrs), d, std::nullopt /* condition */, if_not_exists, false}
...
insert_json_statement::insert_json_statement(cf_name name,
                                             ...
                                             bool default_unset,
                                             dialect d)
    : raw::modification_statement{name, std::move(attrs), d, std::nullopt /* condition */, if_not_exists, false}
    , _name(name)
...
update_statement::update_statement(cf_name name,
                                   ...
                                   dialect d)
    : raw::modification_statement(std::move(name), std::move(attrs), d, std::move(conditions), false, if_exists)
