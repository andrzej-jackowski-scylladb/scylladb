...
cql3::statements::alter_table_statement::do_prepare(data_dictionary::database db, prepare_context& ctx, cql_stats& stats, const cql_config& cfg) {
...
std::unique_ptr<cql3::statements::prepared_statement>
alter_table_statement::raw_statement::do_prepare(data_dictionary::database db, prepare_context& ctx, cql_stats& stats, const cql_config& cfg) {
