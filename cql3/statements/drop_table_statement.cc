...
drop_table_statement::drop_table_statement(cf_name cf_name, bool if_exists, dialect d)
    : schema_altering_statement{std::move(cf_name), d, &timeout_config::truncate_timeout}
