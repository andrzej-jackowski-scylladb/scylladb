...
drop_view_statement::drop_view_statement(cf_name view_name, bool if_exists, dialect d)
    : schema_altering_statement{std::move(view_name), d, &timeout_config::truncate_timeout}
