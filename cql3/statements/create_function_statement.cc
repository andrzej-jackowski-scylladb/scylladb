...
std::unique_ptr<prepared_statement> create_function_statement::do_prepare(data_dictionary::database db, prepare_context& ctx, cql_stats& stats, const cql_config& cfg) {
