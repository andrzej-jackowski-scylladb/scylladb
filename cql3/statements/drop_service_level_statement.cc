...
drop_service_level_statement::drop_service_level_statement(sstring service_level, bool if_exists, dialect d) :
    service_level_statement(d), _service_level(service_level), _if_exists(if_exists) {}
