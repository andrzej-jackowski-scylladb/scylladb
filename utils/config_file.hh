...
public:
    ...
    public:
        ...
        virtual future<> set_value_on_all_shards(const YAML::Node&, config_source) = 0;
    ...
    public:
        ...
        future<> set_value_on_all_shards(const YAML::Node&, config_source) override;
    ...
    void set_initial_config_file_reading_completed();
private:
    ...
    configs
        _cfgs;
    bool _initial_config_file_reading_completed;
};
